...
public class STSClientAction {
    ...
    private boolean useWfreshForTTL = true;
     ...
     * @throws Exception
     */
    public SecurityToken submit(UsernamePasswordCredentials credentials, RequestContext requestContext)
        throws Exception {
        ...
        if (isUseWfreshForTTL()) {
            configureTTL(sts, requestContext);
        }
